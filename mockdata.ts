...
const MockWorkflow = [
  {
    ...
    jobs: [
      ...
      },
      {
        ...
        name: 'PG 7 Metal Somun',
        category: 'Kategori Adı',
        color: ProdobitAppTheme.colors.indigo,
        drafts: [null, null, null, null],
        start_date: '2023-08-04 09:00:00',
        end_date: '2023-08-10 09:00:00',
        users: [MockUsers[0], MockUsers[1]],
      },
      {
        id: getRandomUUID(),
        ...
        color: ProdobitAppTheme.colors.red,
        drafts: [null, null, null, null],
        start_date: '2023-08-10 09:00:00',
        end_date: '2023-08-14 09:00:00',
        users: [MockUsers[0], MockUsers[1]],
      },
    ],
  },
    ...
    jobs: [
      {
        ...
        color: ProdobitAppTheme.colors.red,
        drafts: [null, null, null, null],
        start_date: '2023-08-02 09:00:00',
        end_date: '2023-08-05 09:00:00',
        users: [MockUsers[0], MockUsers[1]],
      },
      {
        id: getRandomUUID(),
