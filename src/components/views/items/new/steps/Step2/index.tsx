...
import { Box, Button, Divider, Image, Menu, Select, Sx, Text, Textarea } from '@mantine/core';

// * Menus
import ItemCodeReader from '@/components/views/items/new/steps/Step2/menus/BarcodeReader';
import ItemCodeCreator from '@/components/views/items/new/steps/Step2/menus/BarcodeCreator';
import ItemBrandCreator from '@/components/views/items/new/steps/Step2/menus/BrandCreatorMenu';
import ItemBrandImageSelector from '@/components/views/items/new/steps/Step2/menus/BrandImageSelector';
